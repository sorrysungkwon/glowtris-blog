...
Every developer has that moment that sends shivers down their spine. For me, it happened a few days ago during **military late-night study time**. I was working on a toy project and mindlessly pushed my code to GitHub. Oops... I had forgotten to add `.env` to my `.gitignore` and pushed it entirely to a public repository.
