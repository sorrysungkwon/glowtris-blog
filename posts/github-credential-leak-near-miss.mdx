...
coverEmoji: "😱"
featured: true
tldr: "If you accidentally leak your security keys on GitHub, automated scanners might not warn you. Never assume you are safe just because you didn't get an email. If exposed, you must instantly revoke the token itself, not just delete the file."
---
